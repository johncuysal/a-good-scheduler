import {printDebugMessage, warn, inform, clear, setText, createElementFromTemplate, hyphenate, move} from './helpers.js?v=2.0.5';
import {getCoursesFromJSON} from './data-processing.js?v=2.0.5';
import GoodScheduler from './GoodScheduler.js?v=2.0.5';
