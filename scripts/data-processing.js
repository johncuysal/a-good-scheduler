import {inform, printDebugMessage, warn} from './helpers.js?v=2.0.5';
import CourseSection from './CourseSection.js?v=2.0.5';
import CorequisiteGroup from './CorequisiteGroup.js?v=2.0.5';
